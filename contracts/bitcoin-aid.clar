;; Title: BitcoinAid - Transparent Charitable Donation Platform
;;
;; Summary: A decentralized donation management system built on Stacks that enables transparent
;;          charitable giving with milestone-based fund utilization tracking and multi-role governance.
;;
;; Description: BitcoinAid leverages Bitcoin's security through Stacks Layer 2 to create a trustless
;;              donation platform where beneficiaries can be registered, donations can be tracked
;;              transparently, and fund utilization is managed through milestone-based approvals.
;;              The system implements role-based access control with administrators, moderators,
;;              and beneficiaries, ensuring proper governance while maintaining transparency.
;;              Perfect for charitable organizations, disaster relief efforts, and community funding
;;              initiatives that require public accountability and Bitcoin-native operations.
...
;; Assign role to a user (only contract owner)
...
;; Remove role from a user (only contract owner)
...
;; Register a new beneficiary (moderators and above)
...
;; Make a donation to a specific beneficiary
...
;; FUND UTILIZATION MANAGEMENT FUNCTIONS

;; Add a new fund utilization milestone (admins only)
...
;; Approve fund utilization for a milestone (admins only)
